...
const ExploreMenu = ({category,setCartegory}) => {
  return (
    <div className='explore-menu' id='explore-menu'>
       ...
       <div className='explore-menu-list'>
        {menu_list.map((item,index)=>{
           return(
           <div onClick={()=>setCartegory(prev=>prev===item.menu_name?'All':item.menu_name)} key={index} className='explore-menu-list-item'>
